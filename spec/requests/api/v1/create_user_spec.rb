...
RSpec.describe "Create A User endpoint" do
  describe "creating user using /register endpoint" do
    ...
    it 'returns an error if the user is not created' do
      user1 = User.create(name:"Person", email: "person@gmail.com", password_digest: "password", password_confirmation: "password") 
      post "/api/v1/register", params: {name: "AnotherPerson", email: "person@gmail.com", password_digest: "password", password_confirmation: "password"}
